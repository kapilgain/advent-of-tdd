...
public class CalibrationValueRecovererTest {
    ...
    @Test
    void findsFirstDigitInStringWithMoreThanTwoDigits() {
        var underTest = new CalibrationValueRecoverer();
        assertEquals('1', underTest.findFirstDigit("a1b2c3d4e5f"));
    }

    @Test
    void findsLastDigitInStringWithOnlyOneDigit() {
        var underTest = new CalibrationValueRecoverer();
        assertEquals('7', underTest.findLastDigit("treb7uchet"));
    }

    @Test
    void findsLastDigitInStringWithTwoDigits() {
        var underTest = new CalibrationValueRecoverer();
    ...
    @Test
    void findsLastDigitInStringWithMoreThanTwoDigits() {
        var underTest = new CalibrationValueRecoverer();
    ...
    @Test
    void throwsRuntimeExceptionWhenRecoveringCalibrationValueFromStringWithNoDigits() {
        assertThrows(RuntimeException.class, () -> new CalibrationValueRecoverer().recoverOne("hello"));
    }

    @Test
    void recoversCalibrationValueForStringWithOnlyOneDigit() {
        var underTest = new CalibrationValueRecoverer();
        assertEquals(77, underTest.recoverOne("treb7uchet"));
    }

    @Test
    void recoversCalibrationValueForStringWithTwoDigits() {
        var underTest = new CalibrationValueRecoverer();
    ...
    @Test
    void recoversCalibrationValueForStringWithMoreThanTwoDigits() {
        var underTest = new CalibrationValueRecoverer();
        assertEquals(15, underTest.recoverOne("a1b2c3d4e5f"));
    }

    @Test
    void recoversCalibrationValuesFromStringList() {
    ...
    @Test
    void findsFirstDigitInSpelledOutString() {
        var underTest = new CalibrationValueRecoverer();
    ...
    @Test
    void findsLastDigitInSpelledOutString() {
        var underTest = new CalibrationValueRecoverer();
    ...
    @Test
    void sumsCalibrationValuesRecoveredFromListContainingSpelledOutStrings() {
        var lines = Arrays.asList(
                "two1nine",
                "eightwothree",
                "abcone2threexyz",
